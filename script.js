...
//       togglePlay(track.preview_url, playButton, audioWrapper);
//     });
...
//     });
//     audioWrapper.appendChild(stopButton);
...
// function togglePlay(url, playButton, wrapper) {
//   if (currentAudio && currentAudio.src === url) {
//     if (currentAudio.paused) {
//       currentAudio.play();
//       playButton.textContent = "Pause";
//       wrapper.querySelector(".stop-button").style.display = "block";
//       playButton.style.display = "none";
//     } else {
//       currentAudio.pause();
//       playButton.textContent = "Play";
//       wrapper.querySelector(".stop-button").style.display = "none";
...
//       currentWrapper.querySelector(".stop-button").style.display = "none";
